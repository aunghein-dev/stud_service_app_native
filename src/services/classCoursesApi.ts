...
import type { ClassCourse, ClassCourseInput, OptionalFeeItem } from '@/types/classCourse';
...
export const classCoursesApi = {
  ...
  create: (input: ClassCourseInput) => apiClient.post<ClassCourse>('/class-courses', input),
  update: (id: number, input: ClassCourseInput) => apiClient.put<ClassCourse>(`/class-courses/${id}`, input),
